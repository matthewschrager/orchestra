                        ...
                        >
                          ...
                          >
                            ...
                            <div className="flex items-center gap-1.5 mt-1 ml-3.5">
                              ...
                              {thread.worktree && (
                                <span
                                  className="inline-flex items-center gap-0.5 text-[10px] px-1 py-0.5 rounded bg-violet-900/40 text-violet-300 max-w-[180px] font-mono"
                                ...
                                >
                                  ...
                                  {thread.baseBranch && (
                                    <span className="text-violet-300/50 truncate">
                                      ← {thread.baseBranch}
                                    </span>
                                  )}
                                </span>
